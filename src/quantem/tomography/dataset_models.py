...
class TomographyFocalINRDataset(TomographyINRDataset):
    ...
    # Ported verbatim from TomographyThroughFocalINRDataset (since deleted; see
    # dataset_models_legacy.py) on 2026-08-10.
    ...
    # Ported verbatim from TomographyThroughFocalProbeINRDataset (since deleted;
    # see dataset_models_legacy.py) on 2026-08-10.
    ...
    # Ported from TomographyThroughFocalAstigmatismINRDataset (since deleted;
    # see dataset_models_legacy.py) on 2026-08-10.
    ...
    # (that class is deleted; see dataset_models_legacy.py)
    ...
    # Ported verbatim from TomographyThroughFocalJustStigINRDataset (since
    # deleted; see dataset_models_legacy.py) on
    ...
    def _compute_probe_weights_a(
        ...
        # implementation in TomographyThroughFocalProbeINRDataset (deleted
...
DatasetModelType = TomographyINRDataset | TomographyPixDataset | TomographyFocalINRDataset
